const dictionaries = {
  en: {
    ...
    'auth.awaitingApprovalAdmin': 'Your admin account is waiting for approval from another administrator.',
    'auth.awaitingApprovalWorker': 'Your worker account is waiting for approval from an administrator.',
    'auth.registeredAwaitingApproval': 'Admin account created and waiting for approval.',
    'auth.registeredAwaitingApprovalWorker': 'Worker account created and waiting for approval.',
    'auth.notifyAdminsSubject': 'New colleague awaiting approval',
    'auth.notifyAdminsText': 'A new colleague account was created and is awaiting approval:\nEmail: {email}\nUsername: {username}\nFull name: {fullname}\n\nReview and approve at: {link}',
  ...
  hu: {
    ...
    'auth.awaitingApprovalAdmin': 'Az admin fiókod jóváhagyásra vár egy másik adminisztrátortól.',
    'auth.awaitingApprovalWorker': 'A dolgozó fiókod egy adminisztrátor jóváhagyására vár.',
    'auth.registeredAwaitingApproval': 'Az admin fiók létrejött, és jóváhagyásra vár.',
    'auth.registeredAwaitingApprovalWorker': 'A dolgozó fiók létrejött, és jóváhagyásra vár.',
    'auth.notifyAdminsSubject': 'Új munkatárs jóváhagyásra vár',
    'auth.notifyAdminsText': 'Egy új munkatárs fiók jött létre és jóváhagyásra vár:\nE-mail: {email}\nFelhasználónév: {username}\nTeljes név: {fullname}\n\nEllenőrizd és jóváhagyhatod itt: {link}',
